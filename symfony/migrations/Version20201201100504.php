 ...
 */
final class Version20201201100504 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gift CHANGE creator_id creator_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE gift DROP FOREIGN KEY FK_A47C990D61220EA6');
        $this->addSql('ALTER TABLE gift CHANGE creator_id creator_id INT NOT NULL');
